...
# Getting report
detected_data_frame = st.session_state['detected_data_frame'] if st.session_state['detected_data_frame'] is not None else st.write(st.header("Generate object detection result first"))
...
if(detected_data_frame is not None):
  ...
  st.write(st.subheader("Please go to Detect page and Detect object first"))